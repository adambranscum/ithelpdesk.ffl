...
class Office365MailTransport extends AbstractTransport
{
    ...
    protected function getAccessToken()
    {
        ...
        $url = 'https://login.microsoftonline.com/28ebe1b7-9cbd-4b94-91b0-1c47ceb89ac7/oauth2/v2.0/token';
        $token = json_decode($guzzle->post($url, [
            'form_params' => [
                'client_id' => '6bbf437f-cd1c-4a9a-bf73-186043d43bac',
                'client_secret' => 'QZ48Q~gMqfATS23YM2rGf.wHlY2kFovyWvFebb1x',
