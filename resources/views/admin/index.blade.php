...
<div class="container mt-4">
    <h2 class="mb-4">Tickets Assigned to All Users</h2>
    ...
    {{-- Filter Form --}}
    <form method="GET" action="{{ route('admin.index') }}" class="row mb-4 g-2">
        <div class="col-md-4">
            <input 
                type="text" 
                name="search" 
        ...
        <div class="col-md-2">
            <a href="{{ route('admin.index') }}" class="btn btn-outline-secondary w-100">Reset</a>
        </div>
    </form>
                    ...
                    <tbody>
                        @foreach($tickets as $ticket)
                            <tr>
                                <td>{{ $ticket->id }}</td>
                                <td>
                                    <a href="{{ route('admin.show', $ticket->id) }}" class="text-decoration-none">
                                        {{ $ticket->subject }}
                                    </a>
                                </td>
