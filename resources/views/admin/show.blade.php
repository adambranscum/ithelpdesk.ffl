...
<div class="card shadow-sm mb-4">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route('admin.updateStatus', $ticket->id) }}" class="row g-3 align-items-end">
            @csrf
            @method('PATCH')
            <div class="col-md-6">
...
<div class="card shadow-sm mb-4">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route('admin.transfer', $ticket->id) }}" class="row g-3 align-items-end">
            @csrf
            @method('PATCH')
