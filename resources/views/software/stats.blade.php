...
<div class="container shadow mt-4 py-4 my-5">
    <div class="row justify-content-center">
        <div class="col-12">
            <!-- Header -->
            <div class="d-flex">
                <h2 class="mb-4 fw-bolder me-auto text-gradient-primary">Software License Statistics</h2>
                <a href="{{ route('software.index') }}" class="ms-auto btn logout-btn mb-4">
                    Back to Software
                </a>
            </div>
            ...
            <div class="row mb-4 text-center">
                ...
                <div class="col-md-3 mb-3">
                    <div class="card shadow-sm border-success">
                        <div class="card-body">
                            <h5 class="card-title text-success">Active Licenses</h5>
                            <h3>{{ $licensesActive }}</h3>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 mb-3">
